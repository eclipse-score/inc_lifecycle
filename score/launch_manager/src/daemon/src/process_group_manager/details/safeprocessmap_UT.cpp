...
TEST_F(SafeProcessMapTest, InsertMultipleNodesThenFindTerminatedRemovesAll)
{
    ...
    {
        EXPECT_EQ(sut_.findTerminated(static_cast<int32_t>(j), 0), score::mw::lifecycle::internal::SafeProcessMapReturnType::kOk);
    }
}
...
TEST_F(SafeProcessMapTest, InsertSamePidTwiceYieldsUntilFindTerminatedResolves)
{
    ...
    score::mw::lifecycle::internal::SafeProcessMapReturnType ret1 = score::mw::lifecycle::internal::SafeProcessMapReturnType::kUndefined;
    score::mw::lifecycle::internal::SafeProcessMapReturnType ret2 = score::mw::lifecycle::internal::SafeProcessMapReturnType::kUndefined;
...
TEST_F(SafeProcessMapTest, FindTerminatedWorksAtMaxTreeDepth)
{
    ...
    NiceMock<MockComponent> cb;
    EXPECT_EQ(sut_.insertIfNotTerminated(0x0000FFFE, &cb), score::mw::lifecycle::internal::SafeProcessMapReturnType::kYield);
    EXPECT_EQ(sut_.insertIfNotTerminated(0x00010000, &cb), score::mw::lifecycle::internal::SafeProcessMapReturnType::kOk);
    EXPECT_EQ(sut_.insertIfNotTerminated(0x0001FFFF, &cb), score::mw::lifecycle::internal::SafeProcessMapReturnType::kYield);
    EXPECT_EQ(sut_.insertIfNotTerminated(0x00000002, &cb), score::mw::lifecycle::internal::SafeProcessMapReturnType::kYield);
}
